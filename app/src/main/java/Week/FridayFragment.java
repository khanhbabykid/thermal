...
public class FridayFragment extends Fragment implements OnRefreshListener{
	...
	public void onRefresh() {
		if(MainActivity.currentFragment==3||MainActivity.currentFragment==5){
			Toast.makeText(getActivity(), "Friday Created!", Toast.LENGTH_SHORT).show();
		}
	}
}

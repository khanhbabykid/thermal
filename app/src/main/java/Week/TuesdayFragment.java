...
public class TuesdayFragment extends Fragment implements OnRefreshListener{
	...
	public void onRefresh() {
		...
		if(MainActivity.currentFragment==0||MainActivity.currentFragment==2){
			Toast.makeText(getActivity(), "Tuesday Created!", Toast.LENGTH_SHORT).show();
		}
	}
}

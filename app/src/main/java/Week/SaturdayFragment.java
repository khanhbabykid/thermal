...
public class SaturdayFragment extends Fragment implements OnRefreshListener{
	...
	public void onRefresh() {
		if(MainActivity.currentFragment==4||MainActivity.currentFragment==6){
			Toast.makeText(getActivity(), "Saturday Created!", Toast.LENGTH_SHORT).show();
		}
	}
}

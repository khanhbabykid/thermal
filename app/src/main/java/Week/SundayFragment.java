...
public class SundayFragment extends Fragment implements OnRefreshListener{
	...
	public void onRefresh() {
		if(MainActivity.currentFragment==5){
			Toast.makeText(getActivity(), "Sunday Created!", Toast.LENGTH_SHORT).show();
		}
	}
}
